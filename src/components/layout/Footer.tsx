        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="#learn" className="text-dark-400 hover:text-primary-400 transition-colors">
                  Learn
                </a>
              </li>
              <li>
                <a href="#transformers" className="text-dark-400 hover:text-primary-400 transition-colors">
                  Transformers
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="#videos" className="text-dark-400 hover:text-primary-400 transition-colors">
                  Videos
                </a>
              </li>
              <li>
                <a href="#roadmap" className="text-dark-400 hover:text-primary-400 transition-colors">
                  Roadmap
                </a>
              </li>
            </ul>
